...
## 1. Đã nộp / trình bày cho cô → `nop-co/`
...
| 18/9 | `nop-co/2026-09-18_JobQuest_Report_Ch1-5.pdf` | Báo cáo Chương 1–5.1, 48 trang | Gặp cô 19/9 |
| 18/9 | `nop-co/2026-09-18_JobQuest_Advisor_Deck.pdf` | Deck báo cáo Ch.1–5, 38 slide, 3 câu hỏi xin quyết định | Gặp cô 19/9 |
...
| Source LaTeX báo cáo Ch.1–5 | ? | Chỉ có PDF |
