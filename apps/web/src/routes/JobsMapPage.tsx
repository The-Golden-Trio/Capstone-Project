...
export function JobsMapPage() {
  ...
  return (
    <>
      ...
      {/* Chơi bằng tiếng Anh thì nói trước cho biết: nội dung kịch bản vẫn là
          tiếng Việt, đỡ hơn nhiều so với để người ta bấm vào rồi mới ngỡ ngàng. */}
      {game.scenariosAreVietnameseOnly && (
        <Note className="mb-4">{t('lang.contentVietnamese')}</Note>
      )}
